  ...
  >
    ...
    <template #body>
      <div class="flex flex-col gap-y-4 leading-relaxed">
        ...
        <p>
          For these analytical purposes, we collect data on page views, user behaviour (downloads and plot control updates), session duration, device type, and location (country).
