    ...
    <template #body>
      <div id="negativeEstimatesBody" class="space-y-5">
        ...
        <details class="space-y-5">
          ...
          <p>Similarly, rounding errors, due to estimating burden with a high number of decimal places, can accumulate over age groups, years and countries to lead to small differences which, in some cases, can result in negative values.</p>
